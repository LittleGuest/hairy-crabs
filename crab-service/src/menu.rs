...
use crab_model::{Mapper, MenuReq, SysMenu};
...
impl MenuSrv {
    ...
    pub async fn page(&self, req: MenuReq) -> CrabResult<Page<SysMenu>> {
        SysMenu::page(&req).await
    }

    pub async fn get_by_id(&self, req: MenuReq) -> CrabResult<Option<SysMenu>> {
    ...
    pub async fn delete(&self, req: MenuReq) -> CrabResult<u64> {
