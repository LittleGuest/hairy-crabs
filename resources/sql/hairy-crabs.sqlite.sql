...
CREATE TABLE `base_table` (
  ...
  `status` char(1) NOT NULL DEFAULT '0' , -- 状态（0正常 1 停用）
  `create_by` varchar(64) DEFAULT NULL , -- 创建者
  `create_dept` varchar(64) DEFAULT NULL , -- 创建部门
  `create_time` datetime DEFAULT NULL , -- 创建时间
  `update_by` varchar(64) DEFAULT NULL , -- 更新者
  `update_time` datetime DEFAULT NULL , -- 更新时间
  `update_ip` varchar(128) DEFAULT NULL , -- 更新IP
  `remark` varchar(500) DEFAULT NULL , -- 备注
  `version` int DEFAULT NULL , -- 版本
  `del_flag` char(1) DEFAULT '0' , -- 删除标志（0存在 1删除）
  `extend_s1` varchar(200) DEFAULT NULL , -- 备用字符串1
  `extend_s2` varchar(200) DEFAULT NULL , -- 备用字符串2
  `extend_s3` varchar(200) DEFAULT NULL , -- 备用字符串3
  `extend_s4` varchar(200) DEFAULT NULL , -- 备用字符串4
  `extend_i1` int DEFAULT NULL , -- 备用整型1
  `extend_i2` int DEFAULT NULL , -- 备用整型2
  `extend_i3` int DEFAULT NULL , -- 备用整型3
  `extend_i4` int DEFAULT NULL , -- 备用整型4
  `extend_d1` datetime DEFAULT NULL , -- 备用日期1
  `extend_d2` datetime DEFAULT NULL , -- 备用日期2
  `extend_d3` datetime DEFAULT NULL , -- 备用日期3
  `extend_d4` datetime DEFAULT NULL , -- 备用日期3
  `extend_f1` double(11,2) DEFAULT NULL , -- 备用浮点1
  `extend_f2` double(11,2) DEFAULT NULL , -- 备用浮点2
  `extend_f3` double(11,2) DEFAULT NULL , -- 备用浮点3
  `extend_f4` double(11,2) DEFAULT NULL , -- 备用浮点4
  PRIMARY KEY (`id`)
);-- '基础表'
...
CREATE TABLE `base_tree_table` (
  `id` varchar(64) NOT NULL,
  `parent_id` varchar(32) DEFAULT '0' , -- 父id
  `parent_ids` varchar(500) DEFAULT NULL , -- 父id集合
  `tree_sort` int DEFAULT '0' , -- 排序
  `tree_sorts` varchar(500) DEFAULT NULL , -- 排序集合
  `tree_level` int DEFAULT NULL , -- 层级
  `tree_leaf` char(1) DEFAULT NULL , -- 是否子节点（0是 1否）
...
CREATE TABLE `gen_config_template` (
  ...
  `function_author` varchar(100) NOT NULL , -- 作者
  `function_author_email` varchar(100) NOT NULL , -- 邮箱
  `workspace_path` varchar(200) DEFAULT NULL , -- 工作空间路径
  `module_name` varchar(30) DEFAULT NULL , -- 模块名
  `package_name` varchar(100) DEFAULT NULL , -- 模块包路径
  `web_workspace_path` varchar(200) DEFAULT NULL , -- 前端工作空间路径
  `template_default` varchar(10) NOT NULL , -- 是否默认
  `sort` int NOT NULL , -- 排序
  `status` char(1) NOT NULL , -- 状态（0正常 1 停用）
...
-- ----------------------------
INSERT INTO `gen_config_template` VALUES ('5d80cad095d040da935df872141f934b', 'test', 'test', 'test', 'C:\\cloud-platform\\gitee\\aidex-sharp\\aidex-system', 'system', 'com.aidex.system', 'C:\\cloud-platform\\gitee\\aidex-sharp\\aidex-ui', 'Y', '10', '0', '1', '100', '2022-03-27 22:29:00', '1', '2022-03-27 22:29:00', '127.0.0.1', null, '1', '0');
...
CREATE TABLE `gen_table` (
  `table_id` bigint NOT NULL AUTO_INCREMENT , -- 编号
  ...
  `workspace_path` varchar(200) DEFAULT NULL , -- 工作空间
  `module_name` varchar(30) DEFAULT NULL , -- 模块名
  `package_name` varchar(100) DEFAULT NULL , -- 包路径
  `business_name` varchar(30) DEFAULT NULL , -- 业务名
  `function_name` varchar(50) DEFAULT NULL , -- 功能名
  `function_author` varchar(50) DEFAULT NULL , -- 作者
  `function_author_email` varchar(200) DEFAULT NULL , -- 邮箱
  `web_workspace_path` varchar(200) DEFAULT NULL , -- 前端工作空间路径
  `gen_type` char(1) DEFAULT '0' , -- 生成代码方式（0zip压缩包 1自定义路径）
  `col_spans` int DEFAULT NULL , -- 展示列数
  `options` varchar(4000) DEFAULT NULL , -- 扩展选项
  `create_by` varchar(64) DEFAULT '' , -- 创建者
  `create_time` datetime DEFAULT NULL , -- 创建时间
  `update_by` varchar(64) DEFAULT '' , -- 更新者
  `update_time` datetime DEFAULT NULL , -- 更新时间
...
-- ----------------------------
INSERT INTO `gen_table` VALUES ('17', 'gen_config_template', '模板配置表', null, null, 'GenConfigTemplate', 'crud', null, null, null, 'genConfigTemplate', '模板配置', null, null, null, '1', null, '{\"treeParentCode\":\"parentId\",\"disableEnableOption\":\"0\",\"attachOption\":\"0\",\"treeCode\":\"id\"}', 'admin', '2021-09-22 22:25:48', '', null, null);
...
CREATE TABLE `gen_table_column` (
  `column_id` bigint NOT NULL AUTO_INCREMENT , -- 编号
  `table_id` varchar(64) DEFAULT NULL , -- 归属表编号
  `column_name` varchar(200) DEFAULT NULL , -- 列名称
  `column_comment` varchar(500) DEFAULT NULL , -- 列描述
  `column_type` varchar(100) DEFAULT NULL , -- 列类型
  `java_type` varchar(500) DEFAULT NULL , -- JAVA类型
  `java_field` varchar(200) DEFAULT NULL , -- JAVA字段名
  `is_pk` char(10) DEFAULT NULL , -- 是否主键（1是）
  `is_increment` char(10) DEFAULT NULL , -- 是否自增（1是）
  `is_required` char(10) DEFAULT NULL , -- 是否必填（1是）
  `is_insert` char(10) DEFAULT NULL , -- 是否为插入字段（1是）
  `is_edit` char(10) DEFAULT NULL , -- 是否编辑字段（1是）
  `is_list` char(10) DEFAULT NULL , -- 是否列表字段（1是）
  `is_query` char(10) DEFAULT NULL , -- 是否查询字段（1是）
  `is_unique` char(10) DEFAULT NULL , -- 是否唯一性
  `is_log` char(10) DEFAULT NULL , -- 是否记录日志
  `is_column_sort` char(10) DEFAULT NULL , -- 是否排序
  `is_new_row` char(10) DEFAULT NULL , -- 新行
  `col_span` int(10) unsigned zerofill DEFAULT '0000000002' , -- 列数
  `align_type` varchar(10) DEFAULT NULL , -- 对齐方式
  `query_type` varchar(200) DEFAULT 'EQ' , -- 查询方式（等于、不等于、大于、小于、范围）
  `html_type` varchar(200) DEFAULT NULL , -- 显示类型（文本框、文本域、下拉框、复选框、单选框、日期控件）
  `dict_type` varchar(200) DEFAULT '' , -- 字典类型
  `col_check` varchar(100) DEFAULT NULL , -- 字段校验
...
CREATE TABLE `sys_dept` (
  `id` varchar(64) NOT NULL,
  `dept_code` varchar(500) DEFAULT NULL , -- 部门编号
  `dept_name` varchar(30) DEFAULT '' , -- 部门名称
  `dept_full_name` varchar(200) DEFAULT NULL , -- 全称
  `leader` varchar(20) DEFAULT NULL , -- 负责人
  `phone` varchar(11) DEFAULT NULL , -- 联系电话
  `email` varchar(50) DEFAULT NULL , -- 邮箱
  `dept_type` varchar(10) DEFAULT NULL , -- 机构类型
  `address` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL , -- 联系地址
  `zip_code` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL , -- 邮政编码
  `dept_pinyin` varchar(500) DEFAULT NULL , -- 部门拼音
  `parent_id` varchar(32) DEFAULT '0' , -- 父id
  `parent_ids` varchar(500) DEFAULT NULL , -- 父id集合
  `tree_sort` int DEFAULT '0' , -- 排序
  `tree_sorts` varchar(500) DEFAULT NULL , -- 排序集合
...
CREATE TABLE `sys_dict_data` (
  `id` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL , -- 岗位ID
  `dict_type` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' , -- 字典类型
  `dict_code` bigint DEFAULT NULL , -- 字典编码
  `dict_value` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' , -- 字典键值
  `dict_label` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' , -- 字典标签
...
INSERT INTO `sys_dict_data` VALUES ('2', 'sys_user_sex', '2', '1', '女', '20', '', '', 'N', '0', 'admin', '2021-01-30 13:27:43', '', null, '性别女', '1', '0', '1', null);
...
CREATE TABLE `sys_job` (
  `job_id` bigint NOT NULL AUTO_INCREMENT , -- 任务ID
...
CREATE TABLE `sys_job_log` (
  `job_log_id` bigint NOT NULL AUTO_INCREMENT , -- 任务日志ID
...
CREATE TABLE `sys_menu` (
  ...
  `menu_code` varchar(500) DEFAULT NULL , -- 菜单编码
  `menu_name` varchar(50) NOT NULL , -- 菜单名称
  `parent_id` varchar(64) DEFAULT '0' , -- 父菜单ID
...
CREATE TABLE `sys_notice` (
  ...
  `notice_content_html` longblob , -- 公告内容HTML
...
CREATE TABLE `sys_notice_user_read` (
  `id` varchar(64) NOT NULL , -- 岗位ID
  `notice_id` varchar(64) NOT NULL , -- 通知公告ID
  `user_id` varchar(64) NOT NULL , -- 系统用户id
  `is_read` varchar(10) DEFAULT NULL , -- 是否已读（0未读，1已读），仅在制定通知接收人时使用
...
CREATE TABLE `sys_oper_log` (
  ...
  `json_result` text , -- 返回结果集
  `log_content` text , -- 日志变更内容
  `status` int DEFAULT '0' , -- 操作状态（0正常 1异常）
  `error_msg` varchar(2000) DEFAULT '' , -- 错误消息
  `oper_time` datetime DEFAULT NULL , -- 操作时间
  `remark` varchar(500) DEFAULT NULL , -- 备注
  `oper_id` bigint DEFAULT NULL , -- 任务ID
  `del_flag` char(1) DEFAULT '0' , -- 删除标志（0代表存在 1代表删除）
  `form_id` varchar(64) DEFAULT NULL , -- 表单数据ID
...
CREATE TABLE `sys_portal_config` (
  `id` varchar(64) NOT NULL , -- 岗位ID
  `name` varchar(200) NOT NULL , -- 小页名称
  `code` varchar(64) NOT NULL , -- 小页编码
  `application_range` varchar(20) DEFAULT NULL , -- 应用范围(S系统,R角色,U用户)
  `is_default` varchar(10) DEFAULT NULL , -- 是否默认
  `resource_id` varchar(64) DEFAULT NULL , -- 资源ID(角色ID或者用户ID)
  `system_defined_id` varchar(64) DEFAULT NULL , -- 系统定义ID区分系统定义和用户自定义
  `content` text , -- 配置信息
  `sort` int DEFAULT NULL , -- 排序
  `status` char(1) NOT NULL , -- 状态
  `create_by` varchar(64) DEFAULT '' , -- 创建者
...
CREATE TABLE `sys_post` (
  ...
  `sort` int NOT NULL , -- 显示顺序
  `status` char(1) NOT NULL , -- 状态（0正常 1删除 2停用）
  `create_by` varchar(64) DEFAULT '' , -- 创建者
  `create_dept` varchar(64) DEFAULT NULL , -- 创建部门
  `create_time` datetime DEFAULT NULL , -- 创建时间
  `update_by` varchar(64) DEFAULT '' , -- 更新者
...
CREATE TABLE `sys_role_menu` (
  `role_id` varchar(64) NOT NULL , -- 角色ID
  `menu_id` varchar(64) NOT NULL , -- 菜单ID
...
CREATE TABLE `sys_theme_config` (
  ...
  `theme_obj` varchar(1000) DEFAULT NULL , -- 对应主题JSON
  `status` char(1) NOT NULL , -- 状态（0正常 1删除 2停用）
  `sort` int NOT NULL , -- 排序
  `create_by` varchar(64) DEFAULT '' , -- 创建者
  `create_dept` varchar(64) DEFAULT NULL , -- 创建部门
...
CREATE TABLE `sys_user` (
  ...
  `dept_id` varchar(50) DEFAULT NULL , -- 部门ID
  `name` varchar(50) DEFAULT NULL , -- 姓名
  `name_en` varchar(50) DEFAULT NULL , -- 英文名
  `no` varchar(50) DEFAULT NULL , -- 用户编号
  `user_name` varchar(30) NOT NULL , -- 登陆名称
  `nick_name` varchar(30) DEFAULT NULL , -- 别称
  `user_type` varchar(2) DEFAULT '0' , -- 前后台类型标识 0:后台用户 1:前台用户
  ...
  `nation` varchar(100) DEFAULT NULL , -- 民族
  `birth_address` varchar(100) DEFAULT NULL , -- 籍贯
  `polity` varchar(50) DEFAULT NULL , -- 政治面貌
  `title` varchar(100) DEFAULT NULL , -- 职称
  `office_tel` varchar(50) DEFAULT NULL , -- 办公电话
  `fax` varchar(50) DEFAULT NULL , -- 传真号
  `work_space` varchar(100) DEFAULT NULL , -- 工作地点
  `sort` int DEFAULT NULL , -- 排序号
  `user_pinyin` varchar(500) DEFAULT NULL , -- 用户姓名全拼和简拼
...
CREATE TABLE `sys_user_post` (
  `user_id` varchar(64) NOT NULL , -- 用户ID
  `post_id` varchar(64) NOT NULL , -- 岗位ID
